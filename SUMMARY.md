...
* [multi-tenant](multi-tenant/README.md)
  ...
  * [Tempo: Robust and SelfTuning Resource Management in Multitenant Parallel Databases](multi-tenant/Tempo: Robust and SelfTuning Resource Management in Multitenant Parallel Databases/README.md)
    * [简介](multi-tenant/Tempo: Robust and SelfTuning Resource Management in Multitenant Parallel Databases/intro.md)
    * [笔记](multi-tenant/Tempo: Robust and SelfTuning Resource Management in Multitenant Parallel Databases/notes.md)
  ...
  * [Achieving class-based QoS for transactional workloads](multi-tenant/Achieving class-based QoS for transactional workloads/README.md)
    * [简介](multi-tenant/Achieving class-based QoS for transactional workloads/intro.md)
    * [笔记](multi-tenant/Achieving class-based QoS for transactional workloads/notes.md)
* [architecture](architecture/README.md)
  ...
  * [笔记](architecture/Adapting Microsoft SQL Server for Cloud Computing/notes.md)
    * [Dynamo Amazon s Highly Available Key-value Store](architecture/Dynamo Amazon s Highly Available Key-value Store/README.md)
  * [简介](architecture/Dynamo Amazon s Highly Available Key-value Store/intro.md)
  * [笔记](architecture/Dynamo Amazon s Highly Available Key-value Store/notes.md)
* [UDF](UDF/README.md)
